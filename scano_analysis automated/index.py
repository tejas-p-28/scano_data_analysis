...
def preprocessed_data(data):
    ...
    file_path = 'E:/scano/scano_analysis automated/all_in_one.csv'
...
def append_to_csv(df, file_path):
    ...
    if os.path.exists(file_path):
        ...
        combined_df = pd.concat([existing_data,new_df]).drop_duplicates().reset_index(drop=True)
...
def execute_preprocess():
    url = 'http://182.168.1.210:3100/v1/analytics/get-month-wise-analytics?startDate=01/01/2024&endDate=30/12/2024'
